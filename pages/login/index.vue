                            ...
                            <!-- login form -->
                                <form @submit.prevent="FormSubmit" class="my-5">
                                    ...
                                    <div class="form-outline mb-3">
                                        <input v-model="username" placeholder="Enter your username" type="text" id="input1" class="InputStyle form-control" />
                                        <p class="text-danger" v-if="UsernameCheck">No Empty email Field</p>
                                    </div>
                                    <!-- Password input -->
