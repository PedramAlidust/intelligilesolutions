        ...
        <div class="row gx-5">
          <div class="col-md-6 col-lg-6 pt-4">
            ...
            <form @submit.prevent="FormSubmit" class="my-4">
              ...
              <button
                type="submit"
                class="btn BtnStyle btn-block my-4 SubmitBtnStyle"
              >
                Send a Message
              </button>
            </form>
          ...
          <div class="col-md-6 col-lg-6">
            <div
              class="d-none d-md-block d-lg-block MapColor text-center"
              style="width: 100%; height: 50%; position: relative"
            >
              <img
                class="LogoImgStyle w-50"
              ...
              <div class="row gx-5">
                <div class="col-lg-6">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <p class="FooterSubMenu ps-lg-2 px-lg-2 px-2 pt-2 pt-lg-2">
                      kandakacollections@gmail.com
                    </p>
                  </div>
                </div>
                <div class="col-lg-6 ps-lg-5 pt-lg-0 pt-md-4">
                  <p class="pt-2 pt-md-0 pt-lg-0 MapTxt pb-md-2 pb-lg-2">
                    Social Media
                  </p>
