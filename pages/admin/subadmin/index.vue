...
export default {
  ...
  async asyncData({ store }) {
    ...
    var config = {
      ...
      headers: {
        Authorization:
        "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvYXBpLmludGVsbGlnaWxlc29sdXRpb25zLmNvbSIsImlhdCI6MTY2MDEzMjY5MCwibmJmIjoxNjYwMTMyNjkwLCJleHAiOjE2NjA3Mzc0OTAsImRhdGEiOnsidXNlciI6eyJpZCI6IjEifX19.PrwaTenS-h9l1mtFgO3tNKq8UtmW0b-Gxw51D0j4M3U",
        "Content-Type": "application/json",
      },
    };
