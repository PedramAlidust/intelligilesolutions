...
<div class="row">
  <div class="col-lg-3 col-md-3">
    <section class="bg-light rounded d-flex justify-content-between">
      <input type="text" style="width: 100%; padding: 10px 15px; border: 0; background: transparent; outline: none;" placeholder="Search Here">
      <button style="padding-left: 20px; padding-right: 20px; background: transparent; border: 0; border-left: 1px solid gray; border-radius: 0;"> <i class="bi bi-search"></i> </button>
    </section>
    <!-- Categories -->
    ...
    <section class="CatSec mt-4 py-2 px-4 d-none d-lg-block">
      ...
      <div class="d-flex align-items-center justify-content-center">
        <button
            type="button"
            class="mt-3 mx-2 btn btn-sm btn-light btn-rounded"
        >
          Beauty
        </button>
        <button
      ...
      <div class="py-3 d-flex align-items-center justify-content-center">
        <button type="button" class="mx-2 btn btn-sm btn-light btn-rounded">
          Makeup
        </button>
        <button type="button" class="mx-2 btn btn-sm btn-light btn-rounded">
          Hair
          ...
          <div class="col-lg-6 col-md-6 p-0 mt-5 px-2">
            <section class="ProductBkg">
              <div class="d-flex product">
                <img
                    src="~/assets/pictures/ProductOne.jpg"
                    class="ProductImg"
                    alt="product"
                />
                <div class="ps-2">
                  <p class="mt-1" style="font-weight: 600;">Sella body butter</p>
                  <p class="py-2" style="opacity: .5;">Lip Care</p>
                  <p class="pb-4" style="opacity: .5;">$2000</p>
                  <!-- switch button -->
                  <div class="d-flex justify-content-between">
                    <p style="opacity: .5;">inactive</p>
                    <!-- Checked switch -->
                    ...
                    <!-- end checked switch -->
                    <p class="ps-3" style="color: #e99d7b;">Active</p>
                  </div>
                </div>
              </div>
            </section>
