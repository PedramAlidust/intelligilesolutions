<template>
  <div class="menu" :class="{ 'menu-light': isLight }">
    ...
    <nuxt-link class="menu-item" to="/profile/cart">
      <div class="menu-item-text">
        <div class="menu-item-user">
    ...
    <nuxt-link class="menu-item" to="/profile/orders">
      <div class="menu-item-text">
        <div class="menu-item-user">
    ...
    <nuxt-link class="menu-item" to="/profile/saved">
      <div class="menu-item-text">
        <div class="menu-item-user">
    ...
    <nuxt-link class="menu-item" to="/profile/comments">
      <div class="menu-item-text">
        <div class="menu-item-user">
