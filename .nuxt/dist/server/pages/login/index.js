...
module.exports.__inject__ = function (context) {
  add("17f6b48e", content, true, context)
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body[data-v-c5eda8da]{overflow-y:hidden!important}.FormMobileBkgStyle[data-v-c5eda8da]{border-radius:15px}.MobileLogo[data-v-c5eda8da]{width:70%}[data-v-c5eda8da]::placeholder{color:#6e7689;opacity:1!important}.MobileBkg[data-v-c5eda8da]{background-color:#055452;min-height:100vh}.GoogleBtn[data-v-c5eda8da]{font-family:Open Sans;font-weight:600;font-size:12pt;text-transform:capitalize;box-shadow:none;border:1px solid #c9c6d1;padding:15px;width:100%}@media screen and (max-width:320px){.GoogleBtn[data-v-c5eda8da]{font-size:8pt}}.Devider[data-v-c5eda8da]{border-bottom:1px solid #e6e6e6}.DeviderTxt[data-v-c5eda8da]{font-family:Open Sans;font-size:16px;background-color:#fff;width:50px;margin:-13px auto}.SignUpTxt[data-v-c5eda8da]{color:#231942}.InputStyle[data-v-c5eda8da],.SignUpTxt[data-v-c5eda8da]{font-family:Open Sans;font-weight:600}.InputStyle[data-v-c5eda8da]{padding:13px;font-size:14px;border:1.5px solid #c9c6d1;border-radius:10px;color:#6e7689}.background[data-v-c5eda8da]{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-size:cover;background-position:50%;background-repeat:no-repeat;min-height:100vh;padding:4% 20%}.LeftBkg[data-v-c5eda8da]{background-color:#055452}.LoginTitle[data-v-c5eda8da]{font-family:Open Sans;font-weight:600;font-size:18pt}.BtnStyle[data-v-c5eda8da]{background-color:#055452!important;color:#fff!important}.BtnStyle[data-v-c5eda8da],.SubmitBtnStyle[data-v-c5eda8da]{font-family:Open Sans;font-weight:600;font-size:12pt}.SubmitBtnStyle[data-v-c5eda8da]{padding:18px;border-radius:8px;text-transform:capitalize}@media screen and (max-width:320px){.SubmitBtnStyle[data-v-c5eda8da]{font-size:10pt;padding:15px}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--6!./node_modules/vue-loader/lib??vue-loader-options!./pages/login/index.vue?vue&type=template&id=c5eda8da&scoped=true&
...
// CONCATENATED MODULE: ./pages/login/index.vue?vue&type=template&id=c5eda8da&scoped=true&
