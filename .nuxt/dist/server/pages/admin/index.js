...
module.exports.__inject__ = function (context) {
  add("10913d54", content, true, context)
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "canvas[data-v-7f6be8a6]{width:100%;height:100%}.TotalOrders[data-v-7f6be8a6]{color:#e1da18}.OverviewNum[data-v-7f6be8a6]{color:#f20000}.TicketNum[data-v-7f6be8a6]{color:#4d77f9}.UserNum[data-v-7f6be8a6]{color:#ed3b65}.ProdNum[data-v-7f6be8a6]{color:#159282}.ProdCount[data-v-7f6be8a6]{font-size:8pt;color:#8898aa}.TotalProd[data-v-7f6be8a6]{width:40px}.StateTitle[data-v-7f6be8a6]{font-family:Open Sans,sans-serif;font-size:10pt;color:#8898aa;padding:15px 15px 0}.DashState[data-v-7f6be8a6]{background-color:#fff;border-radius:5px;min-height:10vh}.AdminUser[data-v-7f6be8a6]{font-family:Source Sans Pro,sans-serif;color:#4d4f5c;font-size:10pt}.AdminImg[data-v-7f6be8a6]{width:30px;height:30px}.RingIcon[data-v-7f6be8a6]{width:55px}.CommentIcon[data-v-7f6be8a6]{width:19px}.BarIcon[data-v-7f6be8a6]{width:2px}.DashBoardIcon[data-v-7f6be8a6]{width:12%}.SearchIcon[data-v-7f6be8a6]{width:15px}[data-v-7f6be8a6]::placeholder{color:#e0e0e5;font-size:10pt}.DashLogo[data-v-7f6be8a6]{width:80%}.Inputstyle[data-v-7f6be8a6]:focus{border-color:none;box-shadow:none}.form-control[data-v-7f6be8a6]{border:none}.form-inline[data-v-7f6be8a6]{width:20%}.AdminBkg[data-v-7f6be8a6]{background-color:#f0f0f7}.NavBar[data-v-7f6be8a6]{background-color:#fff;border-radius:10px;box-shadow:0 1.5px 3px 0 rgba(0,0,0,.05);padding:7px}.IconDist[data-v-7f6be8a6]{margin-top:35px}.ItemsColor[data-v-7f6be8a6]{color:#fff;font-family:Open Sans;font-size:11pt}.SideBkg[data-v-7f6be8a6]{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-repeat:no-repeat;background-position:50%;background-size:cover;min-height:100vh;border-top-right-radius:30px;border-bottom-right-radius:30px}", ""]);
// Exports
